...
namespace PlainSight.Server.Migrations
{
    ...
    [Migration("20260706031652_AddTickerMessages")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PlainSight.Server.Models.Announcement", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("PlainSight.Server.Models.AnnouncementMedia", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("AnnouncementId", "SortOrder");
            ...
            modelBuilder.Entity("PlainSight.Server.Models.BrandingSchedule", b =>
                {
                    ...
                    b.Property<int>("BrandingVideoId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("PlainSight.Server.Models.ContentItem", b =>
                {
                    ...
                    b.Property<int?>("SourceContentItemId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("PlainSight.Server.Models.Device", b =>
                {
                    ...
                    b.Property<int?>("CurrentlyPlayingExpectedDurationSeconds")
                        .HasColumnType("integer");

                    b.Property<DateTime?>("CurrentlyPlayingSince")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.Property<bool>("IsStalledAlertSent")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("PlainSight.Server.Models.EmergencyBroadcast", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("PlainSight.Server.Models.Schedule", b =>
                {
                    ...
                    b.Property<bool>("AutoScreenshotEnabled")
                        .HasColumnType("boolean");
                    ...
                    b.Property<int>("ScreenshotBurstCount")
                        .HasColumnType("integer");

                    b.Property<int>("ScreenshotBurstIntervalSeconds")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("PlainSight.Server.Models.TickerMessage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("PlainSight.Server.Models.AnnouncementMedia", b =>
                {
                    b.HasOne("PlainSight.Server.Models.Announcement", "Announcement")
                        .WithMany("Media")
