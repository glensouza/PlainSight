...
builder.Services.Configure<SvdOptions>(builder.Configuration.GetSection(SvdOptions.SectionName));
builder.Services.AddSingleton<SvdGenerationQueue>();
builder.Services.AddSingleton<SvdGenerationService>();
