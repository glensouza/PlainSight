...
public static class VersionApi
{
    public static RouteGroupBuilder MapVersionApi(this IEndpointRouteBuilder routes)
    {
        ...
        group.MapPost("/", async ([FromForm] string versionNumber, IFormFile file, [FromForm] string? notes, SignageDbContext context, IConfiguration configuration, ILoggerFactory loggerFactory, CancellationToken ct) =>
        {
        ...
        group.MapDelete("/{id:int}", async (int id, SignageDbContext context, IConfiguration configuration, ILoggerFactory loggerFactory, CancellationToken ct) =>
        {
            ILogger logger = loggerFactory.CreateLogger("VersionApi");
        ...
        group.MapGet("/groups", async (SignageDbContext context, CancellationToken ct) =>
        {
        ...
        group.MapPut("/groups/{groupName}", async (string groupName, GroupVersionRequest request, SignageDbContext context, CancellationToken ct) =>
        {
        ...
        group.MapDelete("/groups/{groupName}", async (string groupName, SignageDbContext context, CancellationToken ct) =>
        {
